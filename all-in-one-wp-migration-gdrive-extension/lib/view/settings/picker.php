...
<div id="ai1wmge-settings-modal" class="ai1wmge-modal-container">
		...
		<div class="ai1wmge-file-browser">
			...
			<div class="ai1wmge-file-list" v-if="items.length > 0">
				<div class="ai1wmge-file-item">
					<span style="width: 75%;" class="ai1wmge-file-name-header">
			...
			<ul class="ai1wmge-file-list">
				<li v-for="item in items" v-on:click="select(item)" v-on:dblclick="browse(item)" v-bind:class="{'ai1wmge-dir-selected': (item === selected_folder || item.id === preselected_folder_id) && item.type != 'drive'}" class="ai1wmge-file-item">
					<span style="width: 75%;" class="ai1wmge-file-name">
	...
	<div class="ai1wmge-modal-action">
		<p class="ai1wmge-justified-container">
			...
			<button type="button" class="ai1wm-button-green" v-if="selected_folder" v-on:click="store">
